using Codestellar.CleanArchitecture.Domain.Exceptions;
using Codestellar.CleanArchitecture.Domain.ValueObjects;
using FluentAssertions;
using NUnit.Framework;

namespace Codestellar.CleanArchitecture.Domain.UnitTests.ValueObjects
{
